...
pop_size = st.sidebar.slider(label="Choose the Population size ('N') - Creates a population of size 'N' within the population range", min_value=1000, max_value=20000, value=5000, step=10)
...
sample_number = st.sidebar.slider(label='Choose the number of samples', min_value=10, max_value=2000,value=100,step=10)
